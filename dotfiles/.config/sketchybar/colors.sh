...
# Color Tokens
BAR_COLOR=$(getcolor grey 44)
BAR_BORDER_COLOR=$(getcolor black 0)
HIGHLIGHT=$(getcolor yellow)
HIGHLIGHT_75=$(getcolor yellow 75)
HIGHLIGHT_50=$(getcolor yellow 50)
HIGHLIGHT_25=$(getcolor yellow 25)
HIGHLIGHT_10=$(getcolor yellow 10)
ICON_COLOR=$(getcolor yellow)
ICON_COLOR_INACTIVE=$(getcolor yellow 61)
LABEL_COLOR=$(getcolor green)
LABEL_COLOR_INACTIVE=$(getcolor green 61)
POPUP_BACKGROUND_COLOR=$(getcolor black 75)
POPUP_BORDER_COLOR=$(getcolor black 0)
SHADOW_COLOR=$(getcolor black)
TRANSPARENT=$(getcolor black 20)
STATUS_ICON_COLOR=$(getcolor white 75)
STATUS_LABEL_COLOR=$(getcolor white 75)
